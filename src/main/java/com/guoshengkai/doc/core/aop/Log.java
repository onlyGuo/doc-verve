package com.guoshengkai.doc.core.aop;
...
public class Log {
	 ...
	 * AOP日志 切点
	 */
	@Pointcut("@annotation(com.guoshengkai.doc.core.annotation.po.Log)")
		...
		for (Method method : methods) {
			if (method.getName().equals(name)) {
				...
				if (clazzs.length == info.arguments.length) {
					...
					methodName = method.getAnnotation(com.guoshengkai.doc.core.annotation.po.Log.class).action();
