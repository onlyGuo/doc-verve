package com.guoshengkai.doc.core.beans;


import com.guoshengkai.doc.core.annotation.po.vali.Validation;
import com.guoshengkai.doc.core.annotation.po.vali.enums.ValidationType;
import com.guoshengkai.doc.core.exception.ValidationException;
import com.guoshengkai.doc.core.sql.where.SqlUtil;
import com.guoshengkai.doc.core.util.lambda.LambdaUtil;
import com.guoshengkai.doc.core.util.lambda.SFunction;
...
public class PO {
        ...
        try {
            for (SFunction<T, ?> field : fields) {
                ...
                if (validation != null) {
                    ...
                    if (null == value && validation.require()) {
    ...
    private void checkValue(Object value, Validation validation, String fieldName) {
        if (value instanceof String) {
            ...
            if ("".equals(value) && validation.require()) {
                throw new ValidationException(fieldName + "不能为空");
            }
            ...
            if (validation.maxLength() != 0 && validation.maxLength() < ((String) value).length()) {
                throw new ValidationException(fieldName + "内容长度不能大于" + validation.maxLength() + "位字符");
            }
